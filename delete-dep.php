...
$query = "delete from add_dep where dep_id='$dep_id' ";
...
{
	echo "<script> alert ('Department cannot be deleted') </script>";
    echo "<script>window.open('delete-dep.php','_self')</script>";
}
}
...
<div class="container-fluid">
	<div class="col-lg-12  ">
		<div class="card">
			...
			<a href="" class="list-group-item active" style="background-color: rgb(32,57,53)"> <h2 class="alignmiddle container"><i class="fa fa-address-card" aria-hidden="true"></i> Remove Department </h2></a>
			<div class="card-body">

				<form class="form-group" action="delete-dep.php" method="post">
					<label>Enter Department Id To Remove :</label>
					<input type="number" name="dep_id" class="form-control"><br>

					<input type="submit" oneclick="return confrim('are you sure?')" class="btn btn-primary" name="delete-dep" value="Remove">
