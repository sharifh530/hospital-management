...
else 
{
    ...
    echo "<script>window.open('delete-pat.php','_self')</script>";
}
}
...
<div class="container-fluid">
	<div class="col-lg-12  ">
		<div class="card">
			...
			<a href="" class="list-group-item active" style="background-color: rgb(32,57,53)"> <h2 class="alignmiddle container"><i class="fa fa-address-card" aria-hidden="true"></i> Discharge Patient </h2></a>
			<div class="card-body">

				<form class="form-group" action="delete-pat.php" method="post">
					<label>Enter Patient Id To Discharge :</label>
					<input type="number" name="pat_id" class="form-control"><br>

					<input type="submit"  class="btn btn-primary" name="delete-pat" value="Remove">
