...
$query = "delete from add_staff where staff_id='$staff_id' ";
...
{
	echo "<script> alert ('Staff cannot be deleted') </script>";
    echo "<script>window.open('delete-staff.php','_self')</script>";
}
}
...
<div class="container-fluid">
	<div class="col-lg-12  ">
		<div class="card">
			...
			<a href="" class="list-group-item active" style="background-color: rgb(32,57,53)"> <h2 class="alignmiddle container"><i class="fa fa-address-card" aria-hidden="true"></i> Remove Staff </h2></a>
			<div class="card-body">

				<form class="form-group" action="delete-staff.php" method="post">
					<label>Enter Staff Id To Remove :</label>
					<input type="number" name="staff_id" class="form-control"><br>

					<input type="submit" oneclick="return Confrim('are you sure?')" class="btn btn-primary" name="delete-staff" value="Remove">
