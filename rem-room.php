...
$query = "delete from add_room where room_id='$room_id' ";
...
{
	echo "<script> alert ('Room cannot be Removed') </script>";
    echo "<script>window.open('rem-room.php','_self')</script>";
}
}
...
<div class="container-fluid">
	<div class="col-lg-12  ">
		<div class="card">
			...
			<a href="" class="list-group-item active" style="background-color: rgb(32,57,53)"> <h2 class="alignmiddle container"><i class="fa fa-address-card" aria-hidden="true"></i> Remove Room </h2></a>
			<div class="card-body">

				<form class="form-group" action="rem-room.php" method="post">
					<label>Enter Room Id To Remove :</label>
					<input type="number" name="room_id" class="form-control"><br>

					<input type="submit" oneclick="return confrim('are you sure?')" class="btn btn-primary" name="delete-room" value="Remove">
